                    ...
                    <div className="card-columns listfeaturedtag">
                        ...
                        <div className="card">
                            <div className="row">
                                <div className="col-md-5 wrapthumbnail">
                                    <a href="post.html">
                                        <div className="thumbnail" style={{ backgroundImage: 'url(img/demopic/1.jpg)' }}>
                                        </div>
                                    </a>
                                </div>
                        ...
                        <div className="card">
                            <div className="row">
                                <div className="col-md-5 wrapthumbnail">
                                    <a href="post.html">
                                        <div className="thumbnail" style={{ backgroundImage: 'url(img/demopic/2.jpg)' }}>
                                        </div>
                                    </a>
                                </div>
                                <div className="col-md-7">
                        ...
                        <div className="card">
                            <div className="row">
                                <div className="col-md-5 wrapthumbnail">
                                    <a href="post.html">
                                        <div className="thumbnail" style={{ backgroundImage: 'url(img/demopic/3.jpg)' }}>
                                        </div>
                                    </a>
                                </div>
                                <div className="col-md-7">
                        ...
                        <div className="card">
                            <div className="row">
                                <div className="col-md-5 wrapthumbnail">
                                    <a href="post.html">
                                        <div className="thumbnail" style={{ backgroundImage: 'url(img/demopic/4.jpg)' }}>
                                        </div>
                                    </a>
                                </div>
                                <div className="col-md-7">
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-md-8 col-md-offset-2 col-xs-12">
                        ...
                        <img className="featured-image img-fluid" src="img/demopic/10.jpg" alt="" />
