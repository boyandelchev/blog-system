    ...
    return (
        <div className="card">
            ...
            <div className="card-block">
                <h2 className="card-title"><Link to={`/blog-posts/${blogPost._id}`}>{blogPost.title}</Link></h2>
