        ...
        <div className="authorpostbox">
            <div className="card">
                ...
                <div className="card-block">
                    <h2 className="card-title"><Link to={`/blog-post-details/${blogPost._id}`}>{blogPost.title.substring(0, 100)}</Link></h2>
                    <h4 className="card-text">{blogPost.content.substring(0, 500)}</h4>
                    <div className="metafooter">
                        <div className="wrapfooter">
                            ...
                            <span className="author-meta">
                                <span className="post-name"><a href="#">{blogPost.authorName}</a></span><br />
