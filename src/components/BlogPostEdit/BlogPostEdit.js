...
const BlogPostEdit = () => {
    ...
    const categoriesChangeHandler = (e) => {
        const updatedCategories = [...e.target.options]
            .filter(option => option.selected)
            .map(x => x.value);

        setBlogPost({ ...blogPost, categories: updatedCategories });
    };
                ...
                <div className="col-sm-12 offset-md-1 col-md-10 offset-lg-2 col-lg-8 offset-xl-3 col-xl-6">
                    ...
                    <form onSubmit={blogPostEditHandler} method="POST">
                        <div className="mb-3">
                            ...
                            <input type="text" name="blog-post-create-title" className="form-control" id="blog-post-create-title" defaultValue={blogPost.title} onChange={inputChangeHandler} placeholder="title" />
                        ...
                        <div className="mb-3">
                            ...
                            <textarea name="blog-post-create-content" className="form-control" id="blog-post-create-content" rows="10" defaultValue={blogPost.content} onChange={inputChangeHandler} placeholder="content"></textarea>
                        ...
                        <div className="mb-3">
                            ...
                            <input type="text" name="blog-post-create-image-url" className="form-control" id="blog-post-create-image-url" defaultValue={blogPost.imageUrl} onChange={inputChangeHandler} placeholder="image URL" />
